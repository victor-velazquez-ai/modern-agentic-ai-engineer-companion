...
print("\nwhat changed between them:", diff or "{only the block list at the input edge}")'''
    ...
    md(
        ...
        "plug straight into [`../../capstone-project/agents/tools/`](../../capstone-project/agents/tools/) "
...
print("misses the gate already QUARANTINED — measured, not hoped.")'''
    ...
    md(
        ...
        "*this exact gate* would plug into [`../../capstone-project/agents/tools/`]"
        "(../../capstone-project/agents/tools/) as one more adapter on the existing agent loop."
    ),
]
