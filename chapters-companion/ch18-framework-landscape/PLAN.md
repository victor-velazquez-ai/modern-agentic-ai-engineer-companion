...
- **Capstone:** builds `capstone-project/agents/graph/` (LangGraph) and `capstone-project/agents/pydantic_ai/`
  alongside the raw `capstone-project/agents/raw/` kept as the reference; checkpoint
