...
- **Template(s):** — (the golden-set sketch here previews
  ...
  in Ch 22).
- **Capstone:** no code yet; this is the mental model behind `capstone-project/evals/` (Ch 22) and the
  telemetry in `capstone-project/telemetry.py` (Ch 23). The notebook closes by pointing at both.
