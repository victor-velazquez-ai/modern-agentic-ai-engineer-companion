...
- **Capstone:** no capstone code, but this is the *method the whole `capstone-project/` was designed
  by*; 42-02's worked support-system answer matches `capstone-project/`'s intake/resolution split and
