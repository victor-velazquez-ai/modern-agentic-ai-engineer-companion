...
- **Cell arc:**
  ...
  - Lay out the book's `capstone-project/evals/` structure: `golden/support.jsonl`, `graders.py`,
  ...
  - **Ends pointing at the blueprint:** you built the teaching harness; the production version
    ...
    `capstone-project/evals/`. Note when to graduate to a platform (§22.9: Langfuse / LangSmith /
...
- **Template(s):** [`templates/eval-dataset-template/`](../../templates/eval-dataset-template/)
  ...
  22-01/22-02.
- **Capstone:** advances `capstone-project/evals/` (`golden/`, `graders.py`, `run_evals.py`,
...
- [ ] Each notebook ends with recap + 2–4 change-and-predict exercises and a link to
      `blueprints/eval-harness/`, `templates/eval-dataset-template/`, and `capstone-project/evals/`.
