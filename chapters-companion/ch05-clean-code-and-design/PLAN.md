...
- **Capstone:** seeds `capstone-project/.../providers/` (Protocol + adapter + factory) and
  `capstone-project/.../domain/` (`Thread`/`Message`/`Run` owning their rules) — the chapter's 🔧 Build.
