...
- **The shipped UI is a *template* and the *capstone*, not a notebook.** The production
  ...
  [`capstone-project/web/`](../../capstone-project/web/) (the complete reference frontend). That is where you
...
off the 🔧 **Build (§38.5)** to the web template and `capstone-project/web/`, which is the milestone
(`checkpoints/ch38-web-frontend`) that gives the platform a user-facing front end. The build
artifacts of this part — `templates/web-starter/` and `capstone-project/web/` — are the face that
