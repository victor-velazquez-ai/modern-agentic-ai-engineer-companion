...
- **Capstone:** `capstone-project/evals/` + `.github/workflows/evals.yml` (Ch 22),
  `capstone-project/telemetry.py` (Ch 23); checkpoints `ch22-eval-harness`, `ch23-observability`. These
