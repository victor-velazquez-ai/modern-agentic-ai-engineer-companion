...
- 🎓 **Capstone:** a computer-use tool added to `capstone-project/agents/tools/` should ship with its *own* frozen success-suite and run behind 47-01's human-in-the-loop gate — never autonomous for irreversible actions.
