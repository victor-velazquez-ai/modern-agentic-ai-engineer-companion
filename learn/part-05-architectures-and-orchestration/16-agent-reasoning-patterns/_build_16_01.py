"""Generator for 16-01-react-and-interleaved-thinking.ipynb.

Writes a valid nbformat-4 notebook. Run once, then delete; not shipped.
"""
import json
import os
...
md(
    ...
    "\n",
    "> \U0001f4d3 *Companion to* **Modern Agentic AI Engineer** *· Ch 16 §16.1–16.2 · type: walkthrough*\n",
    "\n",
...
code(
    ...
    "        if any(word in key or word in text.lower() for word in q.split()):\n",
    "            return text\n",
    "    return \"No document matched that query.\"\n",
    "\n",
...
code(
    ...
    "            if b.type == \"thinking\":\n",
    "                print(f\"[{step}] \U0001f4ad thought:      {b.text}\")\n",
    "            elif b.type == \"text\":\n",
    "                print(f\"[{step}] \U0001f4dd say:          {b.text}\")\n",
    "            elif b.type == \"tool_use\":\n",
    "                print(f\"[{step}] \U0001f527 action:       {b.name}({b.input})\")\n",
    "                print(f\"[{step}] \U0001f441️  observation:  {run_tool(b.name, b.input)}\")\n",
...
out = os.path.join(os.path.dirname(__file__), "16-01-react-and-interleaved-thinking.ipynb")
