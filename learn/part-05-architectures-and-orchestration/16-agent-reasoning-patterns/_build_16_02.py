"""Generator for 16-02-plan-execute-reflect-verify.ipynb."""
import json
import os
...
md(
    ...
    "\n",
    "> \U0001f4d3 *Companion to* **Modern Agentic AI Engineer** *· Ch 16 §16.3–16.5 · type: walkthrough*\n",
    "\n",
...
md(
    ...
    "chapter's \U0001f511 key idea) ranks your exit conditions so the loop stops on something *trustworthy*.\n",
    "\n",
...
md(
    "## \U0001f511 The verification ladder\n",
    "\n",
...
out = os.path.join(os.path.dirname(__file__), "16-02-plan-execute-reflect-verify.ipynb")
