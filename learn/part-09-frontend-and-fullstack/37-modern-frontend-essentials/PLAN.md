...
`capstone/web/`; every notebook ends by pointing there.
...
- **Capstone:** orients the reader to [`capstone/web/`](../../../capstone/web/) (the complete
...
- [ ] Each notebook ends with recap + exercises and a link to `templates/web-starter/` and
      `capstone/web/` for the real implementation.
