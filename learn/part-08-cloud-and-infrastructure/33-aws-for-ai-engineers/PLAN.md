...
- **Capstone:** produces the **AWS deploy notes / service map** consumed by `capstone/infra/`;
  the §33.9 architecture is the target that `capstone/app/` and `capstone/workers/` deploy onto.
