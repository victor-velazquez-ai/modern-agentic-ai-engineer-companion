...
- It is **where the capstone is finally assembled and hardened.** Everything since Ch 12 has been
  ...
  `capstone/` rather than building a new one — honoring the book's promise that *you* build yours
...
**guided tour + production-readiness pass** over `capstone/`. Everything runs **offline and free**
...
| 44 | Capstone: End-to-End Production System | The capstone integration chapter — a **guided tour of the assembled `capstone/`** (one request across all four planes) + a **production-readiness pass** (agent versioning/rollout, hardening, the master checklist). *Build yours first, then compare.* | 2 | [PLAN](44-capstone-end-to-end/PLAN.md) |
...
- **Capstone:** Ch 42 is *the method `capstone/` was designed by*; Ch 44 is **the guided tour of
  `capstone/`** end to end and runs the readiness pass against
  [`capstone/`](../../capstone/) and its [`checkpoints/`](../../capstone/checkpoints/).
