...
- **Capstone:** advances `capstone/rag/` (the `Retriever` protocol + `ChromaRetriever`, the
  cited `answer()`), and the eval golden set feeds `capstone/evals/` (Ch 22); checkpoint
...
- [ ] 13-02 ends linking `blueprints/rag-pipeline/` and `capstone/rag/`; 13-03 links Ch 22.
