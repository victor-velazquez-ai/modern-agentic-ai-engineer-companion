...
- **Capstone:** advances `capstone/llm/gateway.py` — adds the metering/budget hooks, exact +
...
- [ ] Each notebook ends with recap + 2–4 change-and-predict exercises; 40-01/40-02/40-03 link
      back to `capstone/llm/gateway.py` and the §40 checklist appears as a copyable cell.
