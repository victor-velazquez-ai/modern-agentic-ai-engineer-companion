...
turn, a session, and (with the SQLite/Postgres backend) a process restart.
...
class MemoryStore:
    ...
    def memorize(self, text: str, *, kind: str = "fact", tags: Iterable[str] = ()) -> MemoryRecord:
    ...
    def save(self) -> None:
        ...
        self.backend.save(self.session_id, self._state())
